...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
	<div class="container-fluid">
		<div class="navbar-header">
			...
			<a class="navbar-brand" href="<?= base_url() ?>" style="margin-left: 1em">
				<!-- SIG Kota Yogyakarta -->
				<img src="<?= base_url() ?>assets/image/new-logo.png" height="36">
			</a>
		</div>
		<div class="collapse navbar-collapse navbar-ex1-collapse">
			<ul class="nav navbar-nav navbar-right">
				<li><a href="<?= base_url('index.php/') ?>" class="hvr-underline-reveal">Beranda</a></li>
				<li><a href="<?= base_url('index.php/peta-indonesia') ?>" class="hvr-underline-reveal">Peta Indonesia</a></li>
				...
				<li>
					<?php if (isset($_SESSION['user'])) : ?>
						<a data-toggle="modal" onclick="return konfirm('Yakin ingin logout?', '<?= base_url() ?>index.php/logout')" class="hvr-rotate">
				...
				<div role="tabpanel">
					...
					<div class="tab-content" style="margin-top: 1em">
						...
						<div role="tabpanel" class="tab-pane" id="usiaSekolah">
							<div class="row text-center inner-tab-modal">
								<div class="col-md-4">
									<img src="<?= base_url() ?>assets/image/osis_sd.png" height="80px">
									<h1 id="usiaSD"></h1>
									<p>Usia SD (7-12 Tahun)</p>
								</div>
								<div class="col-md-4">
									<img src="<?= base_url() ?>assets/image/osis_sma.png" height="80px">
									<h1 id="usiaSMP"></h1>
...
<div class="modal fade" id="modal-pw">
	<div class="modal-dialog modal-sm">
		<div class="modal-content">
			...
			<form method="POST" action="<?= base_url('index.php/ganti-password') ?>">
				<div class="modal-body">
...
<div class="modal fade" id="modal-info" tabindex="-1" role="dialog" aria-labelledby="notifikasiLabel" aria-hidden="true">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<table class="table table-striped">
						...
						<tbody>
							<?php $no = 1 ?>
							<?php foreach ($emparray as $data) : ?>
								<tr>
									<td><?= $no++ ?></td>
									<td><?= $data['nama'] ?></td>
									<td><a class="btn btn-danger" onclick="return konfirm('Yakin ingin menghapus marker?', '<?= base_url() ?>index.php/hapus-marker?id=<?= $data['id'] ?>')"><i class="fa fa=trash"></i> Hapus</a></td>
								</tr>
							<?php endforeach ?>
						</tbody>
					</table>
